...
export const brand = {
  ...
  about: {
    ...
    beliefs: [
      {
        label: "Structured",
        body: "People forget their own value. currnt turns fragmented experience into organized achievements, reusable evidence, and a structured career memory you can draw from at any time.",
      },
      {
        label: "Adaptive",
